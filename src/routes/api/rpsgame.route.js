...
router.get('/recentlog', awaitHandlerFactory(RPSGAMEController.getLog))
...
router.get('/available',awaitHandlerFactory(RPSGAMEController.getAvailable))
router.get('/invitation', awaitHandlerFactory(RPSGAMEController.getInvitation))
